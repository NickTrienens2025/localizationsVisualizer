...
"""
        ...
        for section in sorted_sections:
            ...
            swift_code += await self.generate_section_enum(section, section_entries, level=1)
        
        swift_code += "}\n"
        
        return swift_code

    async def generate_section_enum(self, section: Dict, entries: List[Dict], level: int) -> str:
